...
saved_username = ["Slash Mark Chatbot"]
ans=["Slash Mark Chatbot"]
window_size = "400x400"
...
class ChatInterface(Frame):
    ...
    def __init__(self, master=None):
        ...
        help_option.add_command(label="About Slash Mark Chatbot", command=self.msg)
    ...
    def msg(self):
        tkinter.messagebox.showinfo("Slash Mark Chatbot v1.0",
                                    'Slash Mark Chatbot is a chatbot for answering question regranding to Internship\nIt is based on retrival-based NLP using pythons NLTK tool-kit module\nGUI is based on Tkinter')

    def about(self):
        tkinter.messagebox.showinfo("Slash Mark Chatbot Developers","Harshvardhan")
